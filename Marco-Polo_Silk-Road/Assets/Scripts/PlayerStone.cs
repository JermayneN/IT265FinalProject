    ...
    void Update()
    {
               ...
               targetPosition) < smoothDistance)
        {
            ...
            )
            {
                ...
                // Check for fight
                // This automatically assumes that the defender lost and they are removed from the board 
                // the player starts over at their home base 
                if(stoneToFight != null)
                {
                    stoneToFight.ReturnToStorage();
                    stoneToFight = null;
